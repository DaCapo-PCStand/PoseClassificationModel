...
csv_path = "./temporary_data_"+args["label"]+'.csv'

img = path+"image_{}.jpg"
#img = "images/image_.jpg"
...
for i in range(423,args["image_num"]):
    ...
    # COCO Model
    frame_COCO = output_keypoints(l,frame=frame_coco, proto_file=protoFile_coco, weights_file=weightsFile_coco,
...
# csv_control.list_to_csv(rows, args['csv_filename'])
